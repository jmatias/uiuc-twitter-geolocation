...
one_hot_labels = keras.utils.to_categorical(labels, num_classes=55)
one_hot_labels_val = keras.utils.to_categorical(labels_val, num_classes=55)

# Train the model, iterating on the data in batches of 32 samples
model.fit(input_x, one_hot_labels, epochs=10000, batch_size=1028, validation_data=(input_x_val,one_hot_labels_val))
